...
| tell-k
| すまてく(2017.5.19) at SmartNews

Disclaimer
=====================================

* この発表は去年(2016年)のPycon.jpで話した内容です。
* 元々45分の発表用なので今日は途中すっ飛ばします m(_ _)m 
...
* https://tell-k.github.io/smatech201705/
...
.. code-block:: python
 ...
 print(inspect.isclass(spamobj))    # => False
 print(isinstance(spamobj, type))   # => False
 print(isinstance(spamobj, Spam))   # => True
 print(isinstance(spamobj, object)) # => True
...
.. figure:: https://dl.dropboxusercontent.com/spa/ghyn87yb4ejn5yy/e78f8914e57f48c7a00e53430b1a82e8.png
